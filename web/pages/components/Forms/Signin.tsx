  ...
  return (
    <form className="space-y-4" autoComplete='off' onSubmit={handleSubmitSignInForm}>
      ...
      <div className='flex flex-row relative group outline-none'>
          ...
          <Input onChange={handleChangeFormValue} id="email" name="email" type="email" value={signInFormValues.email} placeholder="Email" required />
        </div>
        <div className='flex flex-row relative group outline-none'>
      ...
      <div className='flex flex-row gap-2 m-2'>
        <button onClick={() => signIn('github')} type="button" className="bg-gradient-to-r from-[#9333EA] to-[#3B82F6] relative w-full flex justify-center items-center py-2 text-md font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-[#9333EA] focus:ring-offset-2">
          Entrar com <GithubLogo size={25} style={{ marginLeft: 5}} />
        </button>
        <button onClick={() => signIn('google')} type="button" className="bg-gradient-to-r from-[#9333EA] to-[#3B82F6] relative w-full flex justify-center items-center py-2 text-md font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-[#9333EA] focus:ring-offset-2">
